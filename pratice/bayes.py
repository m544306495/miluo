...
def trainNBO (dataset, classlebels) :
    num_of_sample = len (dataset)   #样本数
    num_of_feature = len (dataset[0])  #特征数
...
testEntry = ['steak', 'garbage']
test = changeword2vec(testEntry,wordlist)
a = classifyNB(test,p0V,p1V,pAb)
print(testEntry, 'classified as: ', classifyNB(test, p0V, p1V, pAb))
# print (p0V)
# print (p1V)
# print (pAb)
